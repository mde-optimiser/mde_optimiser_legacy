...
public class ZooFitnessFunction implements FitnessFunction {
  /**
  ...
  public double computeFitness(final EObject model) {
    Double _xblockexpression = null;
    {
      ...
      _xblockexpression = IterableExtensions.<EObject, Double>fold(((EList<EObject>) _eGet), Double.valueOf(0.0), _function);
    }
