...
public class DebuggableSimpleMO implements OptimisationAlgorithm {
  /**
  ...
  public DebuggableSimpleMO(final int maxIterations, final int maxPopulationSize, final String pathPrefix, final TestModelProvider mp) {
  ...
  public Set<EObject> execute(final OptimisationInterpreter interpreter) {
    Set<EObject> _xblockexpression = null;
    {
      ...
      for (final Integer i : _doubleDotLessThan) {
        {
          String _format = String.format("%02d", i);
          final String genPathPrefix = ((this.pathPrefix + "/gen") + _format);
          this.modelWriter.storeModels(currentPareto, (genPathPrefix + "/initial_population"));
          ...
          this.modelWriter.storeModels(newSolutions, (genPathPrefix + "/new_solutions"));
